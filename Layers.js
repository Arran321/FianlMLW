class Layer {
  constructor() {
    ...
    let c = hexToRgb(document.getElementById("cp1").value)
    PALETTE.push(color(c.r, c.g, c.b))
    c = hexToRgb(document.getElementById("cp2").value)
    PALETTE.push(color(c.r, c.g, c.b))
...
class Circles extends Layer {
  ...
  render() {
    if(document.getElementById(this.constructor.name).checked)
    {
      noFill()
...
class SimpleLines extends Layer {
  ...
  render() {
    if(!document.getElementById(this.constructor.name).checked) return
    noFill()
    stroke(this.layerColor)
